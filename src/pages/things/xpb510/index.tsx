...
export const XPB510: React.FC = () => {
  ...
  const tabItems: DropdownProps[] = [
    { index: 0, label: 'Overview', items: basicConfigItems },
    { index: 1, label: 'Network', items: networkItems },
    { index: 2, label: 'Firewall', items: firewallItems },
    { index: 3, label: 'ALG', items: algItems },
    { index: 4, label: 'Routing', items: routingItems },
    { index: 5, label: 'Administrator', items: administratorItems },
    { index: 6, label: 'Status', items: statusItems },
    { index: 7, label: 'IOT', items: iotTabs },
  ]
