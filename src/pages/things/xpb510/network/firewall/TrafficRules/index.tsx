...
export const TrafficRules = () => {
  ...
  const data = useSelector(
    (state: RootStateProps) => state.xpb510.network.firewall.trafficRules,
  )
  ...
  const handleDelete = (key: string) => {
    sendWsSetMessage(XPB_EVENT_ACTIONS.XPB_510_FIREWALL_DELETE_TRAFFIC_RULES, {
      'cbi.submit': '1',
  ...
  useEffect(() => {
    setIsFetch(true)
    sendWsGetMessage(XPB_EVENT_ACTIONS.XPB_510_FIREWALL_GET_TRAFFIC_RULES_PAGE)
