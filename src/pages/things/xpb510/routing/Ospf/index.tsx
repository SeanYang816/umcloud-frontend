...
export const Ospf = () => {
  ...
  const formik = useFormik<FormikValuesType>({
    ...
    onSubmit: (values) => {
      sendWsSetMessage(XPB_EVENT_ACTIONS.XPB_510_ROUTING_SET_OSPF_PAGE, {
  ...
  const handleDialogOpen = (key: string) => {
    editKey.current = key
    sendWsGetMessage(XPB_EVENT_ACTIONS.XPB_510_ROUTING_GET_OSPF_EDIT_PAGE, key)
  }
  ...
  useEffect(() => {
    setIsFetch(true)
    sendWsGetMessage(XPB_EVENT_ACTIONS.XPB_510_ROUTING_GET_OSPF_PAGE)
